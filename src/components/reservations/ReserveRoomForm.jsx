...
import { getBookingSources, getPaymentMethods, getRoomTypes } from "../../api/rooms.api";
import { CalendarIcon, UserIcon, PhoneIcon, EnvelopeIcon, HomeIcon, TagIcon, DocumentIcon } from "@heroicons/react/24/outline";

const ReserveRoomForm = ({onSuccess}) => {
    ...
    const [bookingSource, setBookingSource] = useState(0);
    ...
    const fetchBookingSources = async () => {
        const res = await getBookingSources();
        setSources(res.filter(s => s.is_active));
    }
    ...
    const handlePercentChange = (value) => {
        ...
        setDiscountAmountInput(amount.toFixed(2));
    };
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <form onSubmit={createReservation} className="p-6">
                    ...
                    <div className="mt-6 pt-6 border-t border-gray-200">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-4">
                                ...
                                <div>
                                    <label className="block text-xs text-gray-500 mb-1">Reservation Note</label>
                                    <div className="relative">
                    ...
                    <div className="mb-6 mt-4">
                        <p className="block text-xs text-gray-500 mb-1">Advance Payment</p>
                        <div className="flex flex-col sm:flex-row gap-4">
                            <div className="w-full sm:w-48">
                                ...
                                >
                                    <option value="0">Booking Source</option>
                                    {Array.isArray(sources) && sources.map((m) => (
